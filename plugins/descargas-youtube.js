...
if (!text) throw `*❌ ERROR... Falto escribir el titulo.*`
try {
...
»  ${yt_play[0].title}
﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘
*✅ Descargado correctamente.*`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {   
try {  
...
»  ${yt_play[0].title}
﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘﹘
*✅ Descargado correctamente.*`, thumbnail: await fetch(n4) }, { quoted: m })
} catch {
}}}    
}} catch {
handler.limit = 0
